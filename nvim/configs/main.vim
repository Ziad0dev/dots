...
" Set a custom welcome message with occult symbols
let &titlestring = "⛧ HAIL SATAN ⛧"
set title

" Display a welcome message when starting Neovim without a file
augroup BloodOccultWelcome
  autocmd!
  autocmd VimEnter * if argc() == 0 && !exists('s:std_in') | echohl ErrorMsg | echo "HAIL SATAN" | echohl None | endif
augroup END
