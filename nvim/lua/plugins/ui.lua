...
return {
  -- Fuzzy Finder (Telescope)
  {
    ...
    keys = {
      ...
      { "<leader>fc", "<cmd>Telescope find_files cwd=~/.config<cr>", desc = "Find Config File" },
        ...
        sections = {
          lualine_a = { 
            {
              "mode",
              fmt = function(str)
                return icons.occult.cross .. " " .. str .. " " .. icons.occult.cross
              end
            }
          },
          lualine_b = { 
          ...
          lualine_c = {
            ...
            { 
              ...
              path = 1, 
              symbols = { 
                modified = " " .. icons.occult.demon .. " ", 
                readonly = " " .. icons.occult.skull .. " ", 
                unnamed = " " .. icons.occult.candle .. " " 
              } 
            },
          },
          lualine_x = {
          ...
          lualine_z = {
            function()
              local crosses = {"⸸", "⛧", "☦"}
              local idx = tonumber(os.date("%S")) % #crosses + 1
              return crosses[idx] .. " " .. os.date("%R") .. " " .. crosses[idx]
            end,
          },
        },
